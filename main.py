...
for anime_name, anime_url in all_anime.items():
    ...
    with open(f"core/html/0_Моя_геройская_академия_(шестой_сезон)___Boku_no_Hero_Academia_6th_Season.html", "r", encoding="UTF-8") as file:
        src = file.read()
    ...
    with open(f"core/json/info_anime.json", "a") as file:
    ...
    print(f"Осталось итератции: {iter_count}")
